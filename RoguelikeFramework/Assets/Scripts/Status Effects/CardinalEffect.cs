...
[EffectGroup("Monster Specific")]
[CreateAssetMenu(fileName = "New CardinalEffect", menuName = "Status Effects/CardinalEffect", order = 1)]
public class CardinalEffect : Effect
{
