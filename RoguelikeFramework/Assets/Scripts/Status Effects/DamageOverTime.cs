...
[CreateAssetMenu(fileName = "New DamageOverTime", menuName = "Status Effects/DamageOverTime", order = 1)]
public class DamageOverTime : Effect
{
    public Roll damagePerTurn;
    public Roll numTurns;
