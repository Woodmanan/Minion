...
[CreateAssetMenu(fileName = "New Vampirism", menuName = "Status Effects/Vampirism", order = 1)]
public class Vampirism : Effect
{
    
    [SerializeField] int heal_percent;
    Monster target;
    ...
    public Vampirism(int heal_percent)
    {
        //Construct me!
    ...
    public override void OnDealDamage(ref int damage, ref DamageType damageType, ref DamageSource source) {
        target.Heal(damage * this.heal_percent / 100);
    }
